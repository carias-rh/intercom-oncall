...
def get_customer_name():
    try:
        ...
        WebDriverWait(driver, 1).until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[1]/div/div[1]/div[3]/div/div/div/div[2]/div/div/div[2]/div[1]/div/a/div[2]'))).click()
